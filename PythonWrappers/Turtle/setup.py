...
setup(name="TurtleWrapper",version="1.0",
    ext_modules=[
        Extension("TurtleWrapper", ["TurtleWrapper.cc","../../LEngine/src/Turtle.cc"],
        libraries = ["boost_python-mt-py27",'cxxadt'],
        library_dirs = ['/opt/local/lib','../../c++adt/lib','../../LEngine/lib'],
        include_dirs = ['/opt/local/include','../../c++adt/include','../../c++adt/include',
                        '../../stl-lignum/include','../../LEngine/include'])
    ])
