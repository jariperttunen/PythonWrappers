...
print "Configuring firmament with 10 inclinations, 20 azimuths, 1 zenith and 1200 MJ total radiant intensity"
...
print "Resizing the firmament to 20 azimuths, 18 inclinations and with 1200 MJ total radiant intensity"
...
print "Configuring the firmament from the file Firmament.txt" 
